...
urlpatterns = [
    ...
    path('create_comments/', comments_views.CommentsCreatePIView.as_view(), name='create_attendance_records_comments'),
    path('comment/<int:id>', comments_views.CommentRetrieveUpdateDestroy.as_view(), name='retrieve_attendance_records_comment')
