...
class TestSendEmails():
    ...
    def test_send_single_email_successfully(self, client, new_user):
    ...
    @pytest.mark.django_db
    def test_send_multiple_emails_successfully(self, client, new_user, new_user2):
        """Test for sending a single email successfully"""
        new_user.save()
        new_user2.save()
        url = reverse('staff:send-mail')
    ...
    @pytest.mark.django_db
    def test_send_unsuccessful_email(self, client, new_user):
